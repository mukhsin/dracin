CREATE TABLE `auth_accounts` (
	...
	`access_token` text,
	`refresh_token` text,
	`access_token_expires_at` integer DEFAULT (cast((julianday('now') - 2440587.5)*86400000 as integer)) NOT NULL,
	`refresh_token_expires_at` integer DEFAULT (cast((julianday('now') - 2440587.5)*86400000 as integer)) NOT NULL,
	`scope` text,
	`id_token` text,
	`password` text,
